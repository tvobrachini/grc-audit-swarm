...
class AuditState(BaseModel):
    ...
    active_skill_ids: List[str] = Field(default_factory=list, description="IDs of matched skill YAML modules for this audit.")
    active_skill_names: List[str] = Field(default_factory=list, description="Human-readable names of matched skills for display in the UI.")
