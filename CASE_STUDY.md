...
| Scope and access limits | Evidence tools make read-only AWS calls. The README lists the six IAM actions they need. AWS account IDs are redacted before storage and before the model sees the output. | `src/swarm/tools/aws_tools.py` |
